...
import com.eightnineapps.coinly.views.fragments.profiles.little.GiveCoinsFragment
import com.eightnineapps.coinly.views.fragments.profiles.little.RevokeCoinsFragment
...
class LittleProfileHost : AppCompatActivity() {
    ...
    private fun setUpButtons() {
        give_coins_button.setOnClickListener {
            startActivity(Intent(this, GiveCoinsFragment::class.java)
        ...
        revoke_coins_button.setOnClickListener {
            startActivity(Intent(this, RevokeCoinsFragment::class.java)
                .putExtra("profile_picture_uri", observedUserInstance.profilePictureUri)
                .putExtra("display_name", observedUserInstance.displayName)
                .addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION))
        }
